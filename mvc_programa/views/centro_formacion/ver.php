        ...
        <div class="detail-card">
            <div class="detail-card-body">
                <div class="detail-row">
                    ...
                    <div class="detail-value"><?php echo htmlspecialchars($centro['cent_id']); ?></div>
                </div>
                <div class="detail-row">
                    <div class="detail-label">Nombre del Centro de Formación</div>
                    <div class="detail-value"><?php echo htmlspecialchars($centro['cent_nombre']); ?></div>
                </div>
            </div>
