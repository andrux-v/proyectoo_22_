                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="<?php echo addRolParam('ver.php?codigo=' . $prog['prog_codigo'], $rol); ?>" class="action-btn view-btn" title="Ver detalle">
                                        <i data-lucide="eye"></i>
                                    </a>
                                    <?php if ($rol === 'coordinador' || $rol === 'centro'): ?>
                                        <a href="<?php echo addRolParam('editar.php?codigo=' . $prog['prog_codigo'], $rol); ?>" class="action-btn edit-btn" title="Editar programa">
